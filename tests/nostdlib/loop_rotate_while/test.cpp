...
// DexExpectWatchValue('start',  '0',                     from_line=6, to_line=10)
// DexExpectWatchValue('count',  '4',                     from_line=6, to_line=10)
// DexExpectWatchValue('result', '0', '1', '3', '6',      from_line=6, to_line=10)
// DexExpectWatchValue('ix',     '0', '1', '2', '3', '4', from_line=7, to_line=10)